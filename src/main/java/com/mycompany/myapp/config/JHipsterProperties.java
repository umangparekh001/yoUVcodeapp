...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "yoUVcode@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "yoUVcode API";

        private String description = "yoUVcode API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "yoUVcode";
