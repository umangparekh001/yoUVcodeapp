...
class BlogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Blog entity")
        ...
        .repeat(2) {
            ...
            .post("/api/blogs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "blogTitle":"SAMPLE_TEXT", "description":null, "hits":"0", "blogUrl":"SAMPLE_TEXT", "active_ind":null, "publishDate":"2020-01-01T00:00:00.000Z", "created_date":"2020-01-01T00:00:00.000Z", "last_chng_date":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
